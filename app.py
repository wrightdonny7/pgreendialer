...
def voice():
	...
	found_911 = re.search("^sip:(911)@", to)
	if found_911:
    number = phonenumbers.parse(found_911.group(1),regionCode)
    to = phonenumbers.format_number(number,phonenumbers.PhoneNumberFormat.NATIONAL)
